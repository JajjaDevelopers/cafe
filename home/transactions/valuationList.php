<?php $pageTitle = "Valuation History";?>
...
<form class="regularForm" style="width: 1000px; height:fit-content">
    <h3 class="formHeading">Valuation History</h3>
...
<div class="container text-center d-flex flex-column align-items-end">
        <div>
            <form action="../phpspreadsheet/valuationExport.php" method="post" style="display:none; background-color:inherit;border:none;" id="valuationexcel">
...
<script>
    ...
    function getGrnList(){
      ...
      xhttp.open("GET", "../ajax/valuationList.php?startDate="+frmDt+"&endDate="+toDt+"&custId="+clientId);
      xhttp.send();
    //   document.getElementById("valuationpdf").style.display="block";
      document.getElementById("valuationexcel").style.display="block";
    }
</script>