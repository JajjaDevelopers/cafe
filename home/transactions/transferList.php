<?php $pageTitle = "Transfer History";?>
...
<form class="regularForm" style="width: 1000px; height:fit-content">
    <h3 class="formHeading">Transfer History</h3>
...
<div class="container text-center d-flex flex-column align-items-end">
        <div>
            <form action="../phpspreadsheet/transferExport.php" method="post" style="display:none; background-color:inherit;border:none;" id="transferexcel">
        ...
        <div class=" mt-3 me-5">
            <!-- <a href="../pdfgen/transfer.php" target="_blank"  id="grnpdf" style="display:none;">
...
<script>
    ...
    function getGrnList(){
      ...
      xhttp.open("GET", "../ajax/transferList.php?startDate="+frmDt+"&endDate="+toDt+"&custId="+clientId);
      xhttp.send();
      
    //   document.getElementById("grnpdf").style.display="block";
      document.getElementById("transferexcel").style.display="block";
    }
</script>