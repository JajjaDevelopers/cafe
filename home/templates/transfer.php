    ...
    <div style="display: grid; width:fit-content; margin-left: 70%;">
        ...
        <input type="date" class="shortInput" id="transferDate" name="transferDate" value="<?= $today ?>" style="grid-column: 2; grid-row: 2">
    </div>
<div><br>
    <label>Summary</label>
    <table>
        ...
        <tbody>
            <tr>
                ...
                <td>
                    ...
                    <input id="fromClientName" name="fromClientName" class="tableInput" style="width: 250px;" readonly>
                ...
                <td>
                    ...
                    <input id="toClientName" name="toClientName" class="tableInput" style="width: 250px;" readonly>
