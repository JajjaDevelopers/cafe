...
if(isset($_GET['countNo'])){
  $stockCountvariable=$_GET['countNo'];
  // $_SESSION["dryNo"] = $dry;
  $_SESSION["stockCountNo"] = $stockCountvariable;
}
?>
<form class="regularForm" style="height: fit-content; width:790px">
  ...
  <div class=" mt-3 me-5 d-flex flex-row justify-content-between">
    ...
    <a href="../pdfgen/stockCountinfo.php" target="_blank" class="" id="pdf" style="display:block;">
