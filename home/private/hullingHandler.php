...
if ($hulling_date != "" && $customer_id != "" && $input_grade_id !="" && $output_qty>0 && $input_grade_id>0){
    //Capturing summary
    ...
    {
        header("location:../processing/hulling?formmsg=success");
    }
} else{
    if(isset($_POST["btnsubmit"]))
        {
            header("location:../processing/hulling?formmsg=fail");
        }
