...
<div id="customerDetailsDiv" style="margin-top: 50px;">
    ...
    <input type="text" id="customerName" name="customerName" value="<?=$cltNme?>" readonly class="longInputField" placeholder="Customer Name" style="margin-left: 0px; margin-right: 0px; width: 280px">
    ...
    <input type="text" id="salesReportContact" value="<?=$contact?>" readonly class="longInputField" placeholder="Contact Person" style="margin-right: 0px; width:150px">
    <label for="salesReportContact" style="margin-left: 39px;">Tel:</label>
    <input type="text" id="salesReportTel" value="<?=$tel?>" readonly class="longInputField" placeholder="Telephone" style="margin-right: 0px; width:120px">
</div>
<script>
