...
<div style="display: grid; width:fit-content; margin-left: 70%;">
    ...
    <input type="text" class="shortInput" id="grnNo" name="grnNo" readonly value="<?= 'GRN-'.$grnNo ?>" style="grid-column: 2; grid-row: 1; margin-top: 0px;">
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            name="driverName" value="<?=$driver?>" style="width:150px">
        </div>
        <div class="col-md-3">
