      ...
      <table style="margin-top: 20px;">
        ...
        <?php
          ...
          for ($row=1; $row<=5; $row++){
            ...
            <td><input type="number" value="" id="<?= $grn.$row.'Qty'?>" readonly name="<?= $grn.$row.'Qty'?>" class="tblNum"></td>
            <td><input type="number" value="" id="<?= $grn.$row.'Mc'?>" readonly name="<?= $grn.$row.'Mc'?>" class="tblNum"></td>
            </tr>
            <?php
          }
        ?>
        <tr>
          ...
          <td><input type="number" value="0" id="batchTotalQty" readonly name="batchTotalQty" class="tblNum" min="1"></td>
          <td><input type="number" value="0" id="avgMc" readonly name="avgMc" class="tblNum"></td>
        </tr>
      </table>
    </div>
