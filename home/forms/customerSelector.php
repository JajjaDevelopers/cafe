...
<div class="container" style="margin: 0px;">
    <div class="row">
        <div class="col-xs-12" id="customerDetailsDiv" style="margin-top: 10px;">
            ...
            <input type="text" id="customerId" name="customerId" value="<?=$cltId?>" readonly class="longInputField" placeholder="ID" style="width: 70px; margin-right: 0px;">
            <input type="text" id="customerName" name="customerName" value="<?=$cltName?>" readonly class="longInputField" placeholder="Customer Name" style="margin-left: 0px; margin-right: 0px; width: 280px">
            ...
            <input type="text" id="salesReportContact" value="<?=$cltContact?>" readonly class="longInputField" placeholder="Contact Person" style="margin-right: 0px; width:150px">
            <label for="salesReportContact" style="margin-left: 39px;">Tel:</label>
            <input type="text" id="salesReportTel" value="<?=$cltTel?>" readonly class="longInputField" placeholder="Telephone" style="margin-right: 0px; width:120px">
        </div>
    </div>
</div>
