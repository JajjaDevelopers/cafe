...
?>
<form class="regularForm" method="post" action="../connection/activitySheetVerification.php" style="height: fit-content; width: 794px">
    <?php 
...
<a href="../verification/activitySheetList" class="btn btn-link" style="color:green">Back</a>
