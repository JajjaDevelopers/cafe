<?php $pageTitle = "Processing Schedule";?>
...
<form class="regularForm" style="width: 1000px; height:fit-content">
    <h3 class="formHeading">Processing Schedule</h3>
...
<script>
    ...
    function getGrnList(){
      ...
      xhttp.open("GET", "../ajax/processingSchedule.php?startDate="+frmDt+"&endDate="+toDt+"&custId="+clientId);
      xhttp.send();
    }
</script>