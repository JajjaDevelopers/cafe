...
?>
<form class="regularForm" method="post" action="../connection/adjustmentApproval.php" style="height: fit-content; width:790px">
  <?php
  ...
  <div class=" mt-3 me-5 d-flex flex-row justify-content-between">
    <a href="../approval/adjustmentList" class="btn btn-link" style="color:green">Back</a>
