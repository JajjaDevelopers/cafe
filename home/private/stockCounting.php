...
if ($cltId!="" && $countDate!="" && ($deficit>0 or $excess>0)){
    //stock summary
    ...
    {
    header("location:../inventory/stkCountCustomer?formmsg=success");
    }
}else{
    if(isset($_POST["btnsubmit"]))
    {
    header("location:../inventory/stkCountCustomer?formmsg=fail");
    }
}
